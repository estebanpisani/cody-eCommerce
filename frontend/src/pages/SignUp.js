                ...
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                        ...
                        <div>
                            ...
                            <input value={firstName} onChange={e=>setFirstName(e.target.value)} required  type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="Nombre" />
                        </div>
                        <div>
                            <label  className="text-sm font-medium leading-none text-gray-800" >
                                {" "}
                            ...
                            <input value={lastName} onChange={e=>setLastName(e.target.value)} required type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="Apellido" />
                        </div>
                        <div>
                            <label  className="text-sm font-medium leading-none text-gray-800" >
                                {" "}
                            ...
                            <input value={userPhoto} onChange={e=>setUserPhoto(e.target.value)} required type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="Foto URL" />
                        </div>
                        <div>
                        ...
                        <div className="mt-6 w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input value={passwordRepeat} onChange={e=>setPasswordRepeat(e.target.value)} required id="myInput" type={showpass ? "text" : "password"} className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                                <div onClick={()=>setShowPass(!showpass)} className="absolute right-0 mt-2 mr-3 cursor-pointer">
                                    <div id="show">
                                        <svg width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
