            ...
            <form onSubmit={handleSubmit} className="bg-indigo-50">
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                        ...
                        <div>
                            <label  className="text-sm font-medium leading-none text-gray-800" value={firstName} onChange={e=>setFirstName(e.target.value)} required>
                                {" "}
                                Nombre{" "}
                            </label>
                            <input  type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="Nombre" />
                        </div>
                        <div>
                            <label  className="text-sm font-medium leading-none text-gray-800" value={lastName} onChange={e=>setLastName(e.target.value)} required>
                                {" "}
                                Apellido{" "}
                            </label>
                            <input  type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="Apellido" />
                        </div>
                        <div>
                            <label  className="text-sm font-medium leading-none text-gray-800" value={image} onChange={e=>setImage(e.target.value)} required>
                                {" "}
                                Foto URL{" "}
                            </label>
                            <input  type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="Foto URL" />
                        </div>
                        <div>
                            <select  className="text-sm font-medium leading-none text-gray-800" onChange={e=>setCountry(e.target.value)} required>
                                {" "}
                                {countries.map( everyCountry => <option>{everyCountry}</option>)}
                            </select>
                        </div>
                        <div>
                            <select  className="text-sm font-medium leading-none text-gray-800" onChange={e=>setRole(e.target.value)} required>
                                {" "}
                                {roles.map( role => <option>{role}</option>)}
                            </select>
                        </div>
                        <div>
                            <label  className="text-sm font-medium leading-none text-gray-800" value={mail} onChange={e=>setMail(e.target.value)} required>
                                {" "}
                                Email{" "}
                            </label>
                        ...
                        <div className="mt-6 w-full">
                            <label  className="text-sm font-medium leading-none text-gray-800" value={password} onChange={e=>setPassword(e.target.value)} required>
                                {" "}
                                Contraseña{" "}
                            </label>
