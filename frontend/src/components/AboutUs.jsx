      ...
      <div className='about-container'>
        <div >
          <h2 className='abouttitle text-xl text-center font-bold py-5'>
            ¿Que o quien es <span className='coText'>CO</span><span className='dyText'>DY</span> ?
          </h2>
          <p className='aboutsub sm:text-lg text-center text-sm'>Cody combina 3 conceptos que viven dentro de cada integrante del staff</p>
          <ul>
