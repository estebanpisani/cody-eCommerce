...
export default function Index() {
    return (
        ...
        <div className="container container-back-img mx-auto">
                                    ...
                                    <Slide index={0}>
                                        <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                            ...
                                            <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                <h2 className="lg:text-xl leading-4 text-base lg:leading-5 text-white">Fecha</h2>
                                                <div className="flex h-full items-end pb-6">
                                                    <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white"><ModalEvent /></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </Slide>
