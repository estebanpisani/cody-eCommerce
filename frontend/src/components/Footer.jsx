...
export const Footer = () => {
  return (
    ...
    <footer class="w-full py-5 footer-container">
      <div class="md:px-12 lg:px-28">
        <div class="container m-auto text-gray-600">
          <img src={Logo} alt="logo tailus" class="w-40 m-auto" />
          <ul role="list" class="py-4 flex flex-col gap-4 items-center justify-center sm:flex-row sm:gap-8">
            ...
            <li role="listitem"><a href="#" class="hover:text-cyan-500">Get started</a></li>
            <li role="listitem"><a href="#" class="hover:text-cyan-500">About us</a></li>
          </ul>
          ...
          <div class="text-center">
            <span class="text-sm tracking-wide">Copyright © Cody <span id="year"></span> | All right reserved</span>
          </div>
        </div>
      </div>
    </footer>
